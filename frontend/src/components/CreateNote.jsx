    ...
    return (
        <>
            <div className="h-screen dark:bg-gray-950">
                <div className="max-w-7xl h-dvh bg-white dark:bg-gray-950 w-11/12 mx-auto flex pt-16 flex-col">
                    <div className="flex items-center gap-4 my-8">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-300">{isEditMode ? 'Edit Catatan' : 'Buat Catatan'}</h1>
                            <p className="text-gray-500 dark:text-gray-400 text-sm">{isEditMode ? "Perbaiki tulisanmu." : "Simpan ide dan rencanamu di sini."}</p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col flex-1 space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2">
                                <label htmlFor="title" className="block dark:text-gray-400 text-sm font-medium text-gray-700">
                                    Judul
                                </label>
                                <input
                                    value={title}
                                    ...
                                    id="title"
                                    placeholder="Judul"
                                    className="dark:bg-gray-900 dark:border-gray-900 dark:text-gray-300 dark:placeholder-gray-500 w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-fuchsia-400 focus:border-fuchsia-400 outline-none transition"
                                />
                            </div>

                            <div className="space-y-2">
                                <label htmlFor="category" className="block dark:text-gray-400 text-sm font-medium text-gray-700">
                                    Kategori
                                </label>
                                <div ref={menuRef} className="w-full relative">

                                    <div className="border bg-white focus-within:ring-2 focus-within:ring-fuchsia-400 focus-within:border-fuchsia-400 transition border-gray-300 rounded-lg overflow-hidden flex dark:bg-gray-900 dark:border-gray-900">
                                        {isCreating ? (
                                            <input
                                                ...
                                                className="w-full px-4 py-2 outline-none dark:text-gray-300 dark:placeholder-gray-500 dark:bg-gray-900 text-gray-700"
                                            />
                                        ) : (
                                            <h1
                                                onClick={() => setIsOpen(!isOpen)}
                                                className={`w-full px-4 py-2 cursor-pointer select-none ${!selectedCategory ? "text-gray-500" : "text-gray-800 dark:text-gray-300"}`}>
                                        ...
                                        <div
                                            onClick={() => setIsOpen(!isOpen)}
                                            className="w-10 items-center flex justify-center bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 hover:bg-gray-300 cursor-pointer">
                                            <svg
                                    ...
                                    ${isOpen ? 'opacity-100 scale-100 visible' : 'opacity-0 scale-95 invisible'} dark:bg-gray-900 dark:border-gray-900`}>
                                        <ul className="py-1">
                                            {categories.map((cat) => (
                                                <li key={cat.id} className="flex group justify-between hover:bg-gray-100 dark:hover:bg-gray-700 items-center">
                                                    {editingCategoryId === cat.id ? (
                                                        <div className="flex-1 flex items-center dark:bg-gray-900 px-2 py-1 gap-2 bg-fuchsia-50">
                                                            <input
                                                                type="text"
                                                                value={editCategoryName}
                                                                onClick={(e) => e.stopPropagation()}
                                                                onChange={(e) => setEditCategoryName(e.target.value)}
                                                                className="flex-1 px-2 py-1 text-sm border border-fuchsia-300 rounded bg-white dark:bg-gray-900 dark:text-gray-300 focus:outline-none focus:ring-1 focus:ring-fuchsia-400"
                                                                autoFocus
                                                            />
                                                        ...
                                                        <>
                                                            ...
                                                            <div className="flex items-center gap-1 mr-2 opacity-100">
                                                                ...
                                                                <div onClick={(e) => handleDeleteCategory(e, cat.id)} className="p-1.5 text-gray-400 hover:text-red-500 rounded-lg cursor-pointer transition-colors" title="Hapus Kategori">
                        ...
                        <div className="mb-5 flex-1 flex flex-col gap-4">
                            <div className="flex-1 flex flex-col space-y-2">
                                <label htmlFor="content" className="block text-sm font-medium dark:text-gray-400 text-gray-700">
                                    Catatan
                                </label>
                                <textarea
                                    value={content}
                                    ...
                                    className="dark:bg-gray-900 dark:text-gray-300 dark:border-gray-900 dark:placeholder-gray-500 flex-1 h-full w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-fuchsia-400 focus:border-fuchsia-400 outline-none transition resize-none"
                                ></textarea>
                            </div>
                            ...
                            <div className="flex justify-end items-center gap-4">
                                <button
                                    ...
                                    ${isSubmitting ? 'bg-fuchsia-300 cursor-not-allowed' : 'bg-fuchsia-400 dark:bg-fuchsia-600 hover:bg-fuchsia-500 focus:ring-4 cursor-pointer'}`}>
                                    {isSubmitting ? (
                                        <>
                                            <span>Menyimpan...</span>
                                        </>
